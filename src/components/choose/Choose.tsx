    ...
    <section ref={sectionRef} className="relative h-[400vh] bg-gray-200 ">
       <div className="sticky top-0 h-screen bg-black overflow-hidden flex items-center justify-start">
        <motion.div 
          ...
          style={{ x }}
        >
          <h3 className=" text-5xl font-bold tracking-widest text-white">Choose a design, and we’ll make it a reality.</h3>
          <picture >
              <Image
              width={300}
              height={300}
          ...
          <h3 className=" text-5xl font-bold tracking-widest text-white">Choose and be unique!</h3>
        </motion.div>
      </div>
    </section>
  )
