...
export default function Enjoy() {
  return (
    <section className="h-screen relative  overflow-hidden">
        <Line/>
        <div className="space-y-10 absolute bottom-0 left-0 right-0 top-0 py-10">
            <div className="flex items-center justify-center">
                <TextMotion positionEndX={100}>
                    <h3 className="text-6xl text-black font-bold">Drip a unique style and be part of our fashion.</h3>
                </TextMotion>
            </div>
            <div className="flex items-center justify-center  h-[500px] ">
                <div className="w-[350px] rounded-2xl shadow-2xl -rotate-12 hover:rotate-0 relative cursor-pointer hover:scale-200 transition-transform ease-in-out
                z-20 p-4 space-y-2 bg-pink-600">
                    <h3 className="text-black text-xl font-semibold">Enjoy unique styles with us.</h3>
                ...
                <div className="w-[350px] rounded-2xl shadow-2xl rotate-45 relative hover:rotate-0 z-10 p-4 space-y-2 hover:scale-200 transition-transform ease-in-out
                bg-lime-600 cursor-pointer hover:z-30">
                    <h3 className="text-black text-xl font-semibold">This is for you</h3>
                    <p className="text-white">
                ...
                <div className="w-[350px] rounded-2xl shadow-2xl rotate-12 relative hover:rotate-0 z-20 p-4 space-y-2 hover:scale-200 transition-transform ease-in-out
                bg-cyan-600 cursor-pointer">
                    <h3 className="text-black text-xl font-semibold">Trippy Threads - Don’t Just Wear It, Live It!</h3>
                    <p className="text-white">
